...
export const extras2: Amal[] = [
  ...
  },
  {
    ...
    steps: [
      "Read or watch for about ten minutes — a book on Al-Islam.org or a talk from the channels below, carrying on where you stopped. Take it in to be changed, not to finish.",
    ...
    links: [
      { group: "Read on Al-Islam.org", label: "Self Building — Ayatullah Ibrahim Amini", note: "A step-by-step guide to purifying the self", url: "https://al-islam.org/self-building-ibrahim-amini" },
      { group: "Read on Al-Islam.org", label: "Jihad al-Akbar — Imam Khomeini", note: "Short talks on the greater struggle, with the self", url: "https://al-islam.org/jihad-al-akbar-greatest-jihad-combat-self-sayyid-ruhullah-musawi-khomeini" },
      { group: "Read on Al-Islam.org", label: "Forty Hadith — Imam Khomeini", note: "Forty narrations on the soul, one at a time", url: "https://al-islam.org/forty-hadith-exposition-second-revised-edition-sayyid-ruhullah-musawi-khomeini" },
      { group: "Read on Al-Islam.org", label: "The Quran with commentary", note: "Translations and Shia tafsir, verse by verse", url: "https://al-islam.org/quran" },
      { group: "Read on Al-Islam.org", label: "The whole library", note: "Hundreds of books on the Ahlul Bayt, beliefs and ethics", url: "https://al-islam.org/" },
      { group: "Watch — talks", label: "Dr Mohammad Ali Shomali", note: "Spirituality and ethics, calm and deep", url: "https://www.youtube.com/@shomali" },
      { group: "Watch — talks", label: "Sayed Ammar Nakshawani", note: "The lives of the Prophet (s) and the Imams (a)", url: "https://www.youtube.com/@SayedAmmarOfficial" },
      { group: "Watch — talks", label: "Sayed Mahdi Modarresi", note: "Short, practical reminders for everyday life", url: "https://www.youtube.com/@SayedModarresi" },
      { group: "Watch — talks", label: "Shaykh Usama Al-Atar", note: "Faith, history and the Ahlul Bayt", url: "https://www.youtube.com/@ualatar" },
      { group: "Watch — talks", label: "Sheikh Mohammed Al-Hilli", note: "Lectures on belief, character and the Quran", url: "https://www.youtube.com/@SheikhHilli" },
      { group: "Watch — talks", label: "Shaykh Jaffer Ladak", note: "Reflections on faith and the inner life", url: "https://www.youtube.com/@JafferLadak" },
      { group: "Watch — talks", label: "Thaqlain", note: "Clear short films on Shia beliefs and history", url: "https://www.youtube.com/@Thaqlain" },
      { group: "Watch — talks", label: "Imam Hussein TV 3", note: "English Shia channel — lectures and programmes", url: "https://www.youtube.com/@imamhusseintv3" },
      { group: "Watch — duas & recitation", label: "Ali Fani", note: "Duas, ziyarat and munajat", url: "https://www.youtube.com/@AliFaniOfficial" },
      { group: "Watch — duas & recitation", label: "Duas.org", note: "Duas with Arabic and English on screen", url: "https://www.youtube.com/@Duas-org" },
      { group: "Watch — duas & recitation", label: "Ali Alhakeem", note: "Reciter — duas and latmiyat", url: "https://www.youtube.com/@AliAlhakeem" },
      { group: "Watch — duas & recitation", label: "Basim Karbalaei", note: "Latmiyat and elegies for the Ahlul Bayt", url: "https://www.youtube.com/@BasimKarbalaei" },
      { group: "Watch — duas & recitation", label: "Abather Al-Halwachi", note: "Latmiyat and nasheeds", url: "https://www.youtube.com/@AlhalwachiCH" },
      { group: "Look up", label: "Duas.org", note: "Mafatih al-Jinan online, with audio", url: "https://duas.org/" },
      { group: "Look up", label: "Sistani.org", note: "Sayyid al-Sistani — Islamic laws and Q&A", url: "https://www.sistani.org/english/" },
    ],
  },
];
